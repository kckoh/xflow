...
from routers import auth, users, connections, catalog, etl_jobs, job_runs, opensearch, duckdb, metadata, domains, logs, admin, ai_catalog
...
# AI Catalog (Auto-generate table/column descriptions with AI)
