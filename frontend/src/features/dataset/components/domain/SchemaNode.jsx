...
export const SchemaNode = ({ id, data }) => {
  ...
  return (
    <div className="relative group font-sans w-[220px]">
      ...
      >
        {/* Black Header */}
        <div className="bg-blue-800 text-white h-[32px] px-2.5 flex justify-between items-center relative rounded-t-lg group/header">
          <span className="text-[10px] font-bold text-slate-300 uppercase tracking-wider bg-white/10 px-1.5 py-0.5 rounded">
            {sourcePlatform}
          </span>
        </div>
