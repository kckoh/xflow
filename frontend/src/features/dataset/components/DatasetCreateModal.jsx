            ...
            <div className="bg-white rounded-xl shadow-2xl w-[500px] border border-gray-200 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Define metadata to initialize the catalog entry.</p>
                    </div>
                ...
                <div className="p-6 overflow-y-auto flex-1 space-y-5">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-400 mt-1">Select the primary business domain for this data.</p>
                    </div>
