  ...
  const handleFetchPreview = async () => {
    ...
    try {
      ...
      if (data.valid) {
        ...
        setError(data.error || "Failed to preview Parquet");
      }
    } catch (err) {
      setError(err.message || "Failed to preview Parquet");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div className="text-xs text-blue-800">
          <p className="font-medium mb-1">Parquet Preview</p>
          <p className="text-blue-700">
            Preview the Parquet file and automatically extract the schema.
          </p>
        </div>
      </div>
