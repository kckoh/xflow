            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-1">
                  <Combobox
                    ...
                    onChange={(option) =>
                      handleConfigChange("region", option.id)
                    }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleConfigChange("access_key_id", e.target.value)
                  }
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleConfigChange("secret_access_key", e.target.value)
                  }
                />
                <p className="mt-1 text-xs text-gray-500">
                  Your credentials are stored securely and only used to access
                  your S3 bucket
                </p>
              </div>
            </div>
          ...
          <div className="border-t border-gray-200 pt-4 mt-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">
                  The folder path within the bucket (without leading/trailing
                  slashes)
                </p>
              </div>
            </div>
